...
namespace IIS.Itogovyjj
{
    ...
    [View("ФормирДокРаспрE", new string[] {
            ...
            "СписокКонтей as \'Список контейнера\'",
    ...
    public class ФормирДокРаспр : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itogovyjj.СписокБарж fСписокБарж;
        
        private IIS.Itogovyjj.ПунктПогрузки fПунктПогрузки;
        
        private IIS.Itogovyjj.СписокКонтей fСписокКонтей;
        ...
        [PropertyStorage(new string[] {
                "ПунктПогрузки"})]
        [NotNull()]
        public virtual IIS.Itogovyjj.ПунктПогрузки ПунктПогрузки
        {
            get
            {
                ...
                IIS.Itogovyjj.ПунктПогрузки result = this.fПунктПогрузки;
        ...
        [PropertyStorage(new string[] {
                "СписокБарж"})]
        [NotNull()]
        public virtual IIS.Itogovyjj.СписокБарж СписокБарж
        {
            get
            {
                ...
                IIS.Itogovyjj.СписокБарж result = this.fСписокБарж;
        ...
        [PropertyStorage(new string[] {
                "СписокКонтей"})]
        [NotNull()]
        public virtual IIS.Itogovyjj.СписокКонтей СписокКонтей
        {
            get
            {
                ...
                IIS.Itogovyjj.СписокКонтей result = this.fСписокКонтей;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ФормирДокРаспрE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФормирДокРаспрE", typeof(IIS.Itogovyjj.ФормирДокРаспр));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ФормирДокРаспрL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФормирДокРаспрL", typeof(IIS.Itogovyjj.ФормирДокРаспр));
                }
            }
        }
    }
