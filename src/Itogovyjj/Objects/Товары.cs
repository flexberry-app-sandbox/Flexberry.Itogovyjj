...
namespace IIS.Itogovyjj
{
    ...
    public class Товары : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itogovyjj.ЕдИзм fЕдиницыИзмер;
        ...
        public virtual IIS.Itogovyjj.ЕдИзм ЕдиницыИзмер
        {
            get
            {
                ...
                IIS.Itogovyjj.ЕдИзм result = this.fЕдиницыИзмер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыE", typeof(IIS.Itogovyjj.Товары));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыL", typeof(IIS.Itogovyjj.Товары));
                }
            }
        }
    }
