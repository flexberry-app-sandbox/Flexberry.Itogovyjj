...
namespace IIS.Itogovyjj
{
    ...
    public class ДокумПоставки : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itogovyjj.Клиенты fКлиенты;
        
        private IIS.Itogovyjj.Организация fОрганизация;
        
        private IIS.Itogovyjj.DetailArrayOfИнфОЗаказе fИнфОЗаказе;
        ...
        [PropertyStorage(new string[] {
                "Клиенты"})]
        [NotNull()]
        public virtual IIS.Itogovyjj.Клиенты Клиенты
        {
            get
            {
                ...
                IIS.Itogovyjj.Клиенты result = this.fКлиенты;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.Itogovyjj.Организация Организация
        {
            get
            {
                ...
                IIS.Itogovyjj.Организация result = this.fОрганизация;
        ...
        public virtual IIS.Itogovyjj.DetailArrayOfИнфОЗаказе ИнфОЗаказе
        {
            get
            {
                ...
                {
                    this.fИнфОЗаказе = new IIS.Itogovyjj.DetailArrayOfИнфОЗаказе(this);
                }
                IIS.Itogovyjj.DetailArrayOfИнфОЗаказе result = this.fИнфОЗаказе;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокумПоставкиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставкиE", typeof(IIS.Itogovyjj.ДокумПоставки));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДокумПоставкиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставкиL", typeof(IIS.Itogovyjj.ДокумПоставки));
                }
            }
        }
    }
