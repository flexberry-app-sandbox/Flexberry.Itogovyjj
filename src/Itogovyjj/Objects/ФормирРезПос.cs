...
namespace IIS.Itogovyjj
{
    ...
    public class ФормирРезПос : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itogovyjj.СостоянЗаказа fСтатусЗаказа;
        
        private bool fНаличиеДеф;
        
        private IIS.Itogovyjj.УдКл fУдовлКлиента;
        
        private IIS.Itogovyjj.ФормирДокРаспр fФормирДокРаспр;
        ...
        public virtual IIS.Itogovyjj.СостоянЗаказа СтатусЗаказа
        {
            get
            {
                ...
                IIS.Itogovyjj.СостоянЗаказа result = this.fСтатусЗаказа;
        ...
        public virtual IIS.Itogovyjj.УдКл УдовлКлиента
        {
            get
            {
                ...
                IIS.Itogovyjj.УдКл result = this.fУдовлКлиента;
        ...
        [PropertyStorage(new string[] {
                "ФормирДокРаспр"})]
        [NotNull()]
        public virtual IIS.Itogovyjj.ФормирДокРаспр ФормирДокРаспр
        {
            get
            {
                ...
                IIS.Itogovyjj.ФормирДокРаспр result = this.fФормирДокРаспр;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ФормирРезПосE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФормирРезПосE", typeof(IIS.Itogovyjj.ФормирРезПос));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ФормирРезПосL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФормирРезПосL", typeof(IIS.Itogovyjj.ФормирРезПос));
                }
            }
        }
    }
