    ...
    public class ПунктПогрузки : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПунктПогрузкиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПунктПогрузкиE", typeof(IIS.Itogovyjj.ПунктПогрузки));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПунктПогрузкиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПунктПогрузкиL", typeof(IIS.Itogovyjj.ПунктПогрузки));
                }
            }
        }
    }
